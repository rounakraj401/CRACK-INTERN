...
//                      int cellno=(i*dot)+j;                  // connecting all boundar dots to leftmost dot(ie 0)
...
//                 if(grid[i][j]=='/')
//                 {
//                     int cell1=(i*dot)+(j+1);      // calculating the corresponding dots that will get connected.
//                     int cell2=((i+1)*dot)+j;    
//                      unionn(cell1,cell2,cnt,rank,par);   // connecting them
